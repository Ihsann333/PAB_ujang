        ...
        children: [
          Padding(
            ...
            child: Column(
              children: [
                if (profilePending) ...[
                  const Text("⚠️ OWNER BARU: Aktivasi Akun & Kos", style: TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xFF9C5A1A))),
                ...
                if (listKos.isNotEmpty) ...[
                  const Row(children: [Icon(Icons.home_work, size: 16), SizedBox(width: 8), Text("UNIT KOS", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 10))]),
                  const SizedBox(height: 12),
  ...
  Widget _buildKostItem(Map<String, dynamic> k, bool hideButtons) {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(k['name'] ?? 'Unit Kos', style: const TextStyle(fontWeight: FontWeight.w900, fontSize: 16)),
          ...
          const SizedBox(height: 12),
          const Text("ATURAN KOS:", style: TextStyle(fontSize: 9, fontWeight: FontWeight.bold, color: Colors.brown)),
